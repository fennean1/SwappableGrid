...
class GameScreen extends Component  {
  ...
  animateTuffysHead(jamType) {
      ...
      let x = getJamJarFromBean(jamType)
        ...
        Animated.sequence([
        Animated.delay(200),
        Animated.spring(this.state.tuffysHeadScale,{toValue: 2, friction: 3, duration: 1200}),
        Animated.timing(this.state.tuffysHeadScale,{toValue: 0, friction: 10, duration: 500}),
              ...
              <View style = {styles.topBarAndGridContainer}>
                  <View style = {styles.topBar}/>
                      <View style = {styles.gridContainer}>
                        <SwappableGrid topMargin = {this.state.topMargin} bounceHead = {this.animateTuffysHead.bind(this)} />
                      </View>
                  </View>
...
export default connect((state) => {return { recipeCount: state.recipeCount} },mapDispatchToProps)(GameScreen);
